                            ...
                            <div className="single-footer">
                                <div className="lg:max-w-[270px]">
                                    ...
                                    {/* <ul className="flex space-x-4 pt-8">
                                        <li>
                                            <a href="#" className="flex h-12 w-12 flex-col items-center justify-center rounded bg-white bg-opacity-[0.08] text-2xl text-white
                            ...
                            <div className="single-footer">
                                ...
                                <div className="mb-4 flex items-center rounded-md bg-white py-[10px] pr-[10px] pl-6 shadow-e1">
                                    ...
                                    <div className="flex-1">
                                        <input type="text" placeholder="Enter your mail" className="border-none focus:ring-0" />
                                    </div>
                                </div>
